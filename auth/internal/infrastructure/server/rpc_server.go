...
import (
	...
	"net/rpc"
	"net/rpc/jsonrpc"
	"projects/LDmitryLD/hugoproxy-microservices/auth/config"
	"projects/LDmitryLD/hugoproxy-microservices/auth/internal/modules/auth/service"
	"projects/LDmitryLD/hugoproxy-microservices/auth/rpc/auth"

	pb "github.com/LDmitryLD/protos/gen/authgrpc/auth"
	"go.uber.org/zap"
